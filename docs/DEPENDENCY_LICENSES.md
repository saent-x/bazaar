...
| Restic | Backup tool | 0.18.1-3ubuntu1 | Ubuntu package / restic project | BSD-2-Clause | N/A | Local encrypted backup and synthetic R2 restore evaluation | Retain package copyright/license notices | Redistribution permitted under BSD-2-Clause terms | N/A | Encrypted repository data only | Approved for evaluation | Codex / 2026-07-10 | Primary project documents authenticated encryption, integrity checks, snapshots, restore, and S3-compatible backends. |
| Cloudflare R2 | Hosted object storage | Account-specific | Cloudflare | Service terms | Service terms | Synthetic encrypted backup evaluation under no-charge controls | N/A | N/A | N/A | Ciphertext and necessary object metadata after activation | Approved for evaluation | Project owner / 2026-07-10 | Standard storage only; remain disabled until `docs/research/R2_BACKUP.md` activation gate passes. |
| Other Cloudflare services | Hosted infrastructure | Account-specific | Cloudflare | Service terms | Service terms | Edge delivery/control plane after configuration review | N/A | N/A | N/A | Metadata depends on enabled service | Candidate | Unassigned | Workers, Tunnel, TURN, and Turnstile reviewed separately before activation. |
